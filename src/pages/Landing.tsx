...
const STEPS = [
  ...
  { n: '03', Icon: Zap,             title: 'Get ranked actions',     desc: 'Gemini AI ranks six specific cuts by kg saved, personalised to your data — not generic advice.', color: 'oklch(0.85 0.14 90)', bg: 'oklch(0.85 0.14 90 / 0.1)', border: 'oklch(0.85 0.14 90 / 0.2)' },
] as const
            ...
            <div>
              ...
              >
                ...
                <span style={{ fontSize: 13, color: 'var(--cl-text-muted)' }}>
                  {hasProfile ? `Welcome back, ${profile!.name}` : 'Built for India · Powered by Gemini AI'}
                </span>
              </motion.div>
      ...
      <section className="relative z-10 w-full px-6 lg:px-16 py-24" style={{ borderTop: '1px solid oklch(0.5 0.02 170 / 0.1)' }}>
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
          <SlideIn from="left">
            ...
            <p className="leading-relaxed mb-7" style={{ color: 'var(--cl-text-muted)' }}>
              Gemini AI reads your exact footprint breakdown and returns six specific actions — ordered by CO₂ impact,
          ...
          <SlideIn from="right" delay={0.1}>
            <div className="space-y-3">
              ...
              <FadeUp delay={0.35}>
                <p className="text-xs text-center pt-1" style={{ color: 'var(--cl-text-subtle)' }}>Generated by Gemini AI · personalised to your footprint</p>
              </FadeUp>
            </div>
          </SlideIn>
        </div>
